...
GLESDebugDraw::GLESDebugDraw()
	: mRatio( 1.0f ), _font(NULL), _screenWidth(0), _screenHeight(0)
{
}
GLESDebugDraw::GLESDebugDraw( float32 ratio )
	: mRatio( ratio ), _font(NULL), _screenWidth(0), _screenHeight(0)
{
}
...
void GLESDebugDraw::DrawString(int x, int y, const char *string, ...)
{
	...
	if (_font)
	{
		...
		glPushMatrix();
		glLoadIdentity();
		glOrthof(0, _screenWidth, _screenHeight, 0, -1024.0f, 1024.0f);
...
#ifdef __QNX__
void GLESDebugDraw::SetScreenSize(float width, float height)
{
	_screenWidth  = width;
